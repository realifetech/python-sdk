...
class DeviceSchema(Schema):
    ...
    os_version = fields.String(data_key='osVersion', allow_none=True, missing=None)
    model = fields.String(allow_none=True, missing=None)
    manufacturer = fields.String(allow_none=True, missing=None)
    bluetooth_on = fields.Boolean(data_key='bluetoothOn', allow_none=True, missing=None)
    wifi_connected = fields.Boolean(data_key='wifiConnected', allow_none=True, missing=None)
